...
var scrollSection = function scrollSection(area) {
  var section = document.querySelector('.' + area + '-section');
  var sectionH3 = section.querySelector('.h3-wrapper');
  var svg1 = sectionH3.querySelector('svg:first-of-type');
  var svg2 = sectionH3.querySelector('svg:last-of-type');
  var sectionMain = section.querySelector('.' + area + '-main');
...
var pdfHref = document.querySelector('.pdf-wrapper');
